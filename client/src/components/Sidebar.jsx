...
const Sidebar = () => (
  <aside className="w-72 bg-[#101010]" aria-label="Sidebar">
    <div className="overflow-y-auto py-4 px-3  text-white rounded dark:bg-gray-800 h-full">
      ...
      <ul className="space-y-2">
        <li>
          <a href="/dashboard" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-700 dark:hover:bg-gray-700">
