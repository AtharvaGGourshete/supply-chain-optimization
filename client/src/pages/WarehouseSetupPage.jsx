...
const SingleProductDashboard = ({ forecastData, onReset }) => {
  ...
  const kpis = [
    {
      label: "Forecasted Demand (1 month)",
    ...
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="mt-2 text-lg text-gray-300">
          Here are your recommendations based on your data.
        </p>
      </div>
  ...
  return (
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="mt-2 text-lg text-gray-300">
          Here are your high-level business predictions.
        </p>
      </div>
      <section className="mt-8">
        {renderChart(
          "Monthly Sales",
          "yhat",
          aggregateData.monthly_sales || [],
          "#8884d8"
        )}
        {renderChart(
          "Quarterly Revenue",
          "yhat",
          aggregateData.quarterly_revenue || [],
          "#82ca9d"
        )}
      </section>
      <div className="flex justify-center pt-8">
...
export default function WarehouseSetupPage() {
  ...
  const handleForecast = async () => {
    ...
    try {
      ...
      setError(
        err.message ||
          "Failed to fetch forecast data. Please check the backend server."
      );
    } finally {
      setLoading(false);
    }
  ...
  const renderStepContent = () => {
    const inputStyles =
      "bg-black/20 border-white/20 focus:ring-2 focus:ring-cyan-500 h-12 text-base text-white";
    ...
    switch (step) {
      case 1:
        return (
          <div className="space-y-8">
            <div className="text-center">
              <h3 className="text-3xl text-[#DDDBCB] font-bold">
                Business Information
              </h3>
              <p className="text-[#DDDBCB] mt-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="contactName" className="text-lg text-[#DDDBCB]">
        ...
        return (
          <div className="space-y-8">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                id="storageLocations"
                placeholder="Describe your bin/location system, e.g., 'Aisle A, Shelf 1, Bin 01'"
                value={formData.storageLocations}
                onChange={handleInputChange}
                className={`${inputStyles} h-24 text-white`}
              />
            </div>
          </div>
        );
            ...
            <div className="space-y-8">
              <div className="text-center">
                ...
                <p className="text-gray-400 mt-1">
                  What kind of forecast do you want to run?
                </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                <Button
          ...
          return (
            <div className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-gray-400 mt-1">
                  Provide sales data and key metrics for a single product.
                </p>
              </div>
              ...
              <p className="text-center text-sm text-gray-400">
                ...
                <strong className="text-white/80">y_sales</strong>,{" "}
                <strong className="text-white/80">y_quantity</strong>, and{" "}
                <strong className="text-white/80">y_deliveries</strong>.
              </p>
              {error && (
          ...
          return (
            <div className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-gray-400 mt-1">
                  Provide high-level data to forecast total monthly sales and
                  quarterly revenue.
                </p>
              </div>
              <div className="flex flex-col items-center justify-center p-12 mt-4 border-2 border-dashed border-white/20 rounded-lg hover:border-yellow-500 hover:bg-black/20 transition-all duration-300">
              ...
              <p className="text-center text-sm text-gray-400">
                Ensure the file has columns for:{" "}
                <strong className="text-white/80">ds</strong>,{" "}
                <strong className="text-white/80">y_sales</strong>, and{" "}
                <strong className="text-white/80">y_revenue</strong>.
              </p>
              {error && (
                <p className="text-center text-red-500 mt-2">{error}</p>
              )}
        ...
        if (loading) {
          return (
            <div className="flex flex-col items-center justify-center w-full min-h-[45vh]">
              ...
              <p className="mt-4 text-yellow-300 font-medium text-lg">
                Running analysis...
              </p>
            </div>
          );
        ...
        <div className="relative z-10 flex flex-col items-center w-full">
          ...
          <Card className="w-full max-w-6xl rounded-2xl border border-white/10 bg-[#0B0F12] shadow-2xl backdrop-blur-xl">
            <CardHeader className="p-8">
              <Stepper
                currentStep={step}
                steps={["Business", "Warehouse", "Analytics", "Results"]}
              />
            </CardHeader>
